...
RUN svn checkout svn://svn.code.sf.net/p/qwt/code/branches/qwt-5.2 /qwt
...
RUN cp /usr/local/qwt-5.2.2-svn/include/*.h /qwtpolar/src/
...
ENV PATH      $PATH:/opt/udh/lib/:/opt/codec2/lib64/:/opt/mpir/lib/:/opt/volk/lib/:/usr/local/qwt-5.2.2-svn/lib/:/usr/local/qwtpolar-1.1.1-svn/lib/
ENV LD_LIBRARY_PATH /usr/lib/:/opt/uhd/lib/:/opt/codec2/lib64/:/opt/mpir/lib/:/opt/volk/lib/:/usr/local/qwt-5.2.2-svn/lib/:/usr/local/qwtpolar-1.1.1-svn/lib/
ENV LD_RUN_PATH     /usr/lib/:/opt/uhd/lib/:/opt/codec2/lib64/:/opt/mpir/lib/:/opt/volk/lib/:/usr/local/qwt-5.2.2-svn/lib:/usr/local/qwtpolar-1.1.1-svn/lib/
...
#    -DQWT_INCLUDE_DIRS= /usr/local/qwt-5.2.2-svn/include \
#    -DQWT_LIBRARIES=/usr/local/qwt-5.2.2-svn/lib \
...
#COPY --from=builder /usr/local/qwt-5.2.2-svn/ /usr/local/qwt-5.2.2-svn/
...
#
#ENV PATH      $PATH:/opt/udh/lib/:/opt/codec2/lib64/:/opt/mpir/lib/:/opt/volk/lib/:/usr/local/qwt-5.2.2-svn/lib/:/usr/local/qwtpolar-1.1.1-svn/lib/:/opt/gnuradio/lib/:/opt/gnuradio/bin/
#ENV LD_LIBRARY_PATH /usr/lib/:/opt/uhd/lib/:/opt/codec2/lib64/:/opt/mpir/lib/:/opt/volk/lib/:/usr/local/qwt-5.2.2-svn/lib/:/usr/local/qwtpolar-1.1.1-svn/lib/:/opt/gnuradio/lib/
#ENV LD_RUN_PATH     /usr/lib/:/opt/uhd/lib/:/opt/codec2/lib64/:/opt/mpir/lib/:/opt/volk/lib/:/usr/local/qwt-5.2.2-svn/lib:/usr/local/qwtpolar-1.1.1-svn/lib/:/opt/gnuradio/lib/
